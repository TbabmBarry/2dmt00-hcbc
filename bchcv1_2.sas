...
/* 
    I want to test the race effect at each level of the place factor.
*/
...
/* Chicago, Il */
proc mixed data=bchc_race cl;
    class race;
    where place = 'Chicago, Il';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    Asian and White had significantly lower mortality rate compared to Black and Hispanic in Chicago.
*/

/* Las Vegas (Clark County), NV */
proc mixed data=bchc_race cl;
    class race;
    where place = 'Las Vegas (Clark County), NV';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    - Asian, White, and Hispanic had significantly lower mortality rate compared to Black in Las Vegas;
    - Asian had significantly lower mortality rate compared to Hispanic in Las Vegas.
*/

/* Long Beach, CA */
proc mixed data=bchc_race cl;
    class race;
    where place = 'Long Beach, CA';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    Asian, Hispanic, and Black had significantly higher mortality rate compared to White in Long Beach.
*/

/* New York City, NY */
proc mixed data=bchc_race cl;
    class race;
    where place = 'New York City, NY';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    - Asian, White, and Hispanic had significantly lower mortality rate compared to Black in New York;
    - Asian and White had significantly lower mortality rate compared to Hispanic in New York;
*/

/* Oakland (Alameda County), CA */
proc mixed data=bchc_race cl;
    class race;
    where place = 'Oakland (Alameda County), CA';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    - Asian, White, and Hispanic had significantly lower mortality rate compared to Black in Oakland;
    - White had significantly lower mortality rate compared to Asian and Hispanic in Oakland.
*/

/* Phoenix, AZ */
proc mixed data=bchc_race cl;
    class race;
    where place = 'Phoenix, AZ';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    - Asian, White, and Hispanic had significantly lower mortality rate compared to Black in Phoenix;
    - White had significantly lower mortality rate compared to Asian and Hispanic in Phoenix.
*/

/* San Diego County, CA */
proc mixed data=bchc_race cl;
    class race;
    where place = 'San Diego County, CA';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    - Asian, White, and Hispanic had significantly lower mortality rate compared to Black in San Diego;
    - White and Asian had significantly lower mortality rate compared to Hispanic in San Diego;
    - Asian had significantly higher mortality rate compared to White in San Diego.
*/

/* San Francisco, CA */
proc mixed data=bchc_race cl;
    class race;
    where place = 'San Francisco, CA';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    - Asian, White, and Hispanic had significantly lower mortality rate compared to Black in San Francisco;
    - White had significantly lower mortality rate compared to Hispanic in San Francisco;
    - Asian had relatively lower mortality rate compared to Hispanic in San Francisco.
*/

/* San Jose, CA */
proc mixed data=bchc_race cl;
    class race;
    where place = 'San Jose, CA';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    - Asian and White had significantly lower mortality rate compared to Black in San Jose;
    - White and Asian had significantly lower mortality rate compared to Hispanic in San Jose.
*/

/* Seattle, WA */
proc mixed data=bchc_race cl;
    class race;
    where place = 'Seattle, WA';
    model logm = race /solution;
    lsmeans race/diff;
run;

/* 
    - Asian, Hispanic, and White had significantly lower mortality rate compared to Black in Seattle;
    - White and Asian had significantly lower mortality rate compared to Hispanic in Seattle.
*/
